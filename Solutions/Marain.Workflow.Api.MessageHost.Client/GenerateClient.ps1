...
$OutputFolder = Join-Path $PSScriptRoot "Marain\Workflows\MessageHost\Client\"
...
#   autorest --latest
autorest --input-file=$tmp --csharp --output-folder=$OutputFolder --namespace=Marain.Workflows.MessageHost.Client --add-credentials