...
Scenario: Update a workflow definition without supplying an eTag
...
Scenario: Update a workflow definition with an etag
...
Scenario: Attempt to update a workflow definition with an etag that does not match the stored version
...
Scenario: Attempt to store a workflow definition when a definition with the supplied Id does not exist succeeds
...
Scenario: Attempt to store a workflow definition when the workflow Id in the path doesn't match that in the body
