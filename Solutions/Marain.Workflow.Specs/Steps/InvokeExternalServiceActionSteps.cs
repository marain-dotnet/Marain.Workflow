// <copyright file="InvokeExternalServiceActionSteps.cs" company="Endjin">
...
namespace Marain.Workflows.Specs.Steps
{
    ...
    public class InvokeExternalServiceActionSteps
    {
        ...
        public async Task ThenTheAuthorizationHeaderShouldBeOfTypeBearerUsingATokenRepresentingTheManagedServiceIdentityAsync()
        {
            ...
            IServiceIdentityTokenSource tokenSource = ContainerBindings.GetServiceProvider(this.featureContext).GetRequiredService<IServiceIdentityTokenSource>();
            string token = await tokenSource.GetAccessToken(this.action.MsiAuthenticationResource).ConfigureAwait(false);
