...
#line hidden
        ...
        public virtual void ExternalActionReturnsA200StatusCodeAndInstanceContextUpdates()
        {
            string[] tagsOfScenario = new string[] {
                    "externalServiceRequired"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("External action returns a 200 status code and instance context updates", null, new string[] {
                        "externalServiceRequired"});
#line 40
this.ScenarioInitialize(scenarioInfo);
#line hidden
