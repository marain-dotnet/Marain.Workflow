...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Sql", "Creating workflow instances with SQL", "\t\t In order to ensure that my workflow instances are created correctly\r\n\t\t And th" +
...
#line hidden
        ...
        public virtual void CreateANewInstance()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create a new instance", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 14
...
#line 15
 testRunner.When("I create and persist a new instance with Id \'new-instance\' of the workflow with I" +
                        "d \'dc-workflow\' and supply the following context items", ((string)(null)), table69, "When ");
#line hidden
#line 19
...
#line 25
 testRunner.And("the following trace messages should have been recorded", ((string)(null)), table70, "And ");
#line hidden
            }
        ...
        public virtual void CreateANewInstanceWithIncompleteData()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create a new instance with incomplete data", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 32
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line 33
 testRunner.When("I create and persist a new instance with Id \'new-instance-incomplete\' of the work" +
                        "flow with Id \'dc-workflow\' and supply the following context items", ((string)(null)), table71, "When ");
#line hidden
#line 36
 testRunner.And("I wait for all triggers to be processed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
