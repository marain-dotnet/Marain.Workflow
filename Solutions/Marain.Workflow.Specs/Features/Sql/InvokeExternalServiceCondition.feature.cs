...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Sql", "InvokeExternalServiceCondition with SQL", "    In order to be able to define a workflow that queries external HTTP endpoints" +
        ...
        public virtual void ExternalConditionReturnsTrue()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("External condition returns true", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 10
...
#line 12
 testRunner.And("I have created and persisted a new instance with Id \'id1\' of the workflow with Id" +
                        " \'external-condition-workflow\' and supplied the following context items", ((string)(null)), table109, "And ");
#line hidden
#line 17
...
#line hidden
        ...
        public virtual void ExternalConditionReturnsFalse()
        {
            string[] tagsOfScenario = new string[] {
                    "externalServiceRequired"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("External condition returns false", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 36
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line 38
 testRunner.And("I have created and persisted a new instance with Id \'id2\' of the workflow with Id" +
                        " \'external-condition-workflow\' and supplied the following context items", ((string)(null)), table110, "And ");
#line hidden
#line 43
    testRunner.And("the external service will return a 200 status", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
        ...
        public virtual void ExternalConditionReturnsA500StatusCode()
        {
            string[] tagsOfScenario = new string[] {
                    "externalServiceRequired"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("External condition returns a 500 status code", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 62
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line 64
 testRunner.And("I have created and persisted a new instance with Id \'id3\' of the workflow with Id" +
                        " \'external-condition-workflow\' and supplied the following context items", ((string)(null)), table111, "And ");
#line hidden
#line 69
