...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Sql", "Edit catalog item with SQL", null, ProgrammingLanguage.CSharp, new string[] {
                        "perFeatureContainer",
                        "useSqlStores",
                        "setupTenantedSqlDatabase"});
        ...
        public virtual void EditItemInTheWaitingForDocumentationState()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Edit item in the Waiting for Documentation state", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
...
#line 10
 testRunner.And("I have created and persisted a new instance with Id \'id1\' of the workflow with Id" +
                        " \'dc-workflow\' and supplied the following context items", ((string)(null)), table84, "And ");
#line hidden
...
#line 16
 testRunner.And("I have an object of type \'application/vnd.endjin.datacatalog.catalogitempatchdeta" +
                        "ils\' called \'patch\'", ((string)(null)), table85, "And ");
#line hidden
...
#line 19
 testRunner.When("I send the workflow engine a trigger of type \'application/vnd.endjin.datacatalog." +
                        "editcatalogitemtrigger\'", ((string)(null)), table86, "When ");
#line hidden
#line 22
...
#line 29
 testRunner.And("the following trace messages should be the last messages recorded", ((string)(null)), table87, "And ");
#line hidden
            }
        ...
        public virtual void EditItemInThePublishedStateWithAChangeThatWouldKeepTheItemComplete()
        {
            string[] tagsOfScenario = new string[] {
                    "useChildObjects"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Edit item in the Published state with a change that would keep the item complete", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 36
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line 39
 testRunner.And("I have created and persisted a new instance with Id \'id2\' of the workflow with Id" +
                        " \'dc-workflow\' and supplied the following context items", ((string)(null)), table88, "And ");
#line hidden
...
#line 45
 testRunner.And("I have an object of type \'application/vnd.endjin.datacatalog.catalogitempatchdeta" +
                        "ils\' called \'InitialPatch\'", ((string)(null)), table89, "And ");
#line hidden
...
#line 48
 testRunner.And("I have an object of type \'application/vnd.endjin.datacatalog.catalogitempatchdeta" +
                        "ils\' called \'TestPatch\'", ((string)(null)), table90, "And ");
#line hidden
...
#line 51
 testRunner.And("I have sent the workflow engine a trigger of type \'application/vnd.endjin.datacat" +
                        "alog.editcatalogitemtrigger\'", ((string)(null)), table91, "And ");
#line hidden
...
#line 54
 testRunner.And("I have sent the workflow engine a trigger of type \'application/vnd.endjin.datacat" +
                        "alog.publishcatalogitemtrigger\'", ((string)(null)), table92, "And ");
#line hidden
...
#line 57
 testRunner.When("I send the workflow engine a trigger of type \'application/vnd.endjin.datacatalog." +
                        "editcatalogitemtrigger\'", ((string)(null)), table93, "When ");
#line hidden
#line 60
 testRunner.And("I wait for all triggers to be processed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 67
 testRunner.And("the following trace messages should be the last messages recorded", ((string)(null)), table94, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 77
 testRunner.And("I have created and persisted a new instance with Id \'id3\' of the workflow with Id" +
                        " \'dc-workflow\' and supplied the following context items", ((string)(null)), table95, "And ");
#line hidden
...
#line 83
 testRunner.And("I have an object of type \'application/vnd.endjin.datacatalog.catalogitempatchdeta" +
                        "ils\' called \'InitialPatch\'", ((string)(null)), table96, "And ");
#line hidden
...
#line 86
 testRunner.And("I have an object of type \'application/vnd.endjin.datacatalog.catalogitempatchdeta" +
                        "ils\' called \'TestPatch\'", ((string)(null)), table97, "And ");
#line hidden
...
#line 89
 testRunner.And("I have sent the workflow engine a trigger of type \'application/vnd.endjin.datacat" +
                        "alog.editcatalogitemtrigger\'", ((string)(null)), table98, "And ");
#line hidden
...
#line 92
 testRunner.And("I have sent the workflow engine a trigger of type \'application/vnd.endjin.datacat" +
                        "alog.publishcatalogitemtrigger\'", ((string)(null)), table99, "And ");
#line hidden
...
#line 95
 testRunner.When("I send the workflow engine a trigger of type \'application/vnd.endjin.datacatalog." +
                        "editcatalogitemtrigger\'", ((string)(null)), table100, "When ");
#line hidden
#line 98
 testRunner.And("I wait for all triggers to be processed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table101.AddRow(new string[] {
                            "Entering state \'Waiting for documentation\'"});
#line 105
 testRunner.And("the following trace messages should be the last messages recorded", ((string)(null)), table101, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
