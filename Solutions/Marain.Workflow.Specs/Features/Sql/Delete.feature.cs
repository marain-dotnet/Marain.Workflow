...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Sql", "Delete an item with SQL", null, ProgrammingLanguage.CSharp, new string[] {
                        "perFeatureContainer",
                        "useSqlStores",
                        "setupTenantedSqlDatabase"});
        ...
        public virtual void DeleteItemWhenItIsInThePublishedState()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Delete item when it is in the published state", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
...
#line 10
 testRunner.And("I have created and persisted a new instance with Id \'id1\' of the workflow with Id" +
                        " \'dc-workflow\' and supplied the following context items", ((string)(null)), table72, "And ");
#line hidden
...
#line 16
 testRunner.And("I have an object of type \'application/vnd.endjin.datacatalog.catalogitempatchdeta" +
                        "ils\' called \'patch\'", ((string)(null)), table73, "And ");
#line hidden
...
#line 19
 testRunner.And("I have sent the workflow engine a trigger of type \'application/vnd.endjin.datacat" +
                        "alog.editcatalogitemtrigger\'", ((string)(null)), table74, "And ");
#line hidden
...
#line 22
 testRunner.And("I have sent the workflow engine a trigger of type \'application/vnd.endjin.datacat" +
                        "alog.publishcatalogitemtrigger\'", ((string)(null)), table75, "And ");
#line hidden
...
#line 25
 testRunner.When("I send the workflow engine a trigger of type \'application/vnd.endjin.datacatalog." +
                        "deletecatalogitemtrigger\'", ((string)(null)), table76, "When ");
#line hidden
#line 28
...
#line 31
 testRunner.And("the following trace messages should be the last messages recorded", ((string)(null)), table77, "And ");
#line hidden
            }
