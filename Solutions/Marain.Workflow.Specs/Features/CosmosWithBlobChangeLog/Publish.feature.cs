...
namespace Marain.Workflows.Specs.Features.CosmosWithBlobChangeLog
{
    ...
    [NUnit.Framework.DescriptionAttribute("Publish an item with Cosmos and blob change log")]
    ...
    public partial class PublishAnItemWithCosmosAndBlobChangeLogFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Publish an item with Cosmos and blob change log", null, ProgrammingLanguage.CSharp, new string[] {
                        "perFeatureContainer",
                        "useCosmosStoresWithBlobChangeLog",
                        "setupTenantedCosmosContainersWithBlobChangeLog"});
