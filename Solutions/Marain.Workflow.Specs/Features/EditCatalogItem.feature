...
Scenario: Edit item in the Waiting for Documentation state
	...
	And I have an object of type "application/vnd.marain.datacatalog.catalogitempatchdetails" called "patch"
	| Id  | Notes         | Description         |
	| id1 | The new notes | The new description |
	When I send the workflow engine a trigger of type "application/vnd.marain.datacatalog.editcatalogitemtrigger"
	| PatchDetails |
	| {patch}      |
...
Scenario: Edit item in the Published state with a change that would keep the item complete
	...
	| AllowWaitingForDocumentationExit | x           |
	| AllowPublishedEntry              | x           |
	And I have an object of type "application/vnd.marain.datacatalog.catalogitempatchdetails" called "InitialPatch"
	| Id  | Notes     | Description     |
	| id2 | The notes | The description |
	And I have an object of type "application/vnd.marain.datacatalog.catalogitempatchdetails" called "TestPatch"
	| Id  | Notes         | Description         |
	| id2 | The new notes | The new description |
	And I have sent the workflow engine a trigger of type "application/vnd.marain.datacatalog.editcatalogitemtrigger"
	| PatchDetails   |
	| {InitialPatch} |
	And I have sent the workflow engine a trigger of type "application/vnd.marain.datacatalog.publishcatalogitemtrigger"
	| CatalogItemId |
	| id2           |
	When I send the workflow engine a trigger of type "application/vnd.marain.datacatalog.editcatalogitemtrigger"
	| PatchDetails |
