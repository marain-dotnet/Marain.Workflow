...
namespace Marain.Workflows
{
    ...
    public interface IWorkflowInstanceChangeLogWriter
    {
        ...
        /// <param name="instance">The workflow instance in its updated state after having processed the trigger, from which to create a snapshot.</param>
        ...
        /// </remarks>
        Task RecordWorkflowInstanceChangeAsync(IWorkflowTrigger trigger, WorkflowInstance instance, string partitionKey = null);
    }
}
