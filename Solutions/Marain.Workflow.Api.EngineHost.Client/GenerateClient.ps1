...
iwr http://localhost:7075/api/swagger -o $tmp
...
#   autorest --latest
$OutputFolder = Join-Path $PSScriptRoot "Endjin\Workflow\Functions\EngineHost\Generated"
autorest --input-file=$tmp --csharp --output-folder=$OutputFolder --namespace=Endjin.Workflow.Functions.EngineHost --add-credentials