...
namespace Marain.Workflows.Client
{
    ...
    /// </summary>
    public partial interface IMarainWorkflowEngine : System.IDisposable
    {
        /// <summary>
        ...
        /// </param>
        Task<HttpOperationResponse> StartWorkflowInstanceWithHttpMessagesAsync(string tenantId, StartWorkflowRequest body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
