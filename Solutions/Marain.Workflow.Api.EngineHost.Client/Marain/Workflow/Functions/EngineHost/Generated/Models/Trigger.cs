...
namespace Marain.Workflow.Functions.EngineHost.Models
{
    ...
    public partial class Trigger
    {
        ...
        public Trigger(string triggerName, IList<string> subjects, string id = default(string), IDictionary<string, string> parameters = default(IDictionary<string, string>))
        {
            Id = id;
